...
export default function FocusMeditationPage({ params }: PageProps) {
  const meditation = {
        ...
        <div>
          <div className="border rounded-xl p-6 sticky top-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/meditations/study-session" className="text-sm hover:text-primary">
                  Study Session Prep (8 min)
                </Link>
              </li>
            </ul>
          </div>
